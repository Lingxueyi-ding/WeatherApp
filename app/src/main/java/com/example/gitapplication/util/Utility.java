        ...
        if(!TextUtils.isEmpty(response)){
            try {
                ...
                for (int i=0;i<allCounties.length();i++){
                    JSONObject countyeObject=allCounties.getJSONObject(i);
                    County county=new County();
                    county.setCountyName(countyeObject.getString("name"));
                    county.setWeatherId(countyeObject.getString("weather_id"));
